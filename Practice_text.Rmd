...
This practice is based on a text analysis work. Therefore, it has been necessary to choose a book to work with. The book selected has been *The Truth about the Titanic", by Archibald Gracie. Basically, it is a recital written by a survivor of the tragic porpular event, in which he tells his own experience.
